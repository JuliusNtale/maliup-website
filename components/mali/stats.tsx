...
const stats = [
  { value: 2400, suffix: "+", label: "Early Users Joined",      sublabel: "Business & personal",   color: "#F5A623", icon: TrendingUp },
  { value: 16,   suffix: "",  label: "Powerful Modules",        sublabel: "Personal + Business",   color: "#22C55E", icon: Layers },
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 flex flex-col gap-4">
          ...
          <p className="reveal text-[#0C1B2E]/65 max-w-md mx-auto leading-relaxed">
            From Dar es Salaam to Lagos — individuals and businesses across Africa are choosing Mali Up to take control of their financial lives.
          </p>
        </div>
